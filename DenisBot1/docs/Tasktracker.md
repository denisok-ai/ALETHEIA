...
- **Шаги выполнения**:
  ...
  - [x] Выкат и повторная генерация — проверено на проде 31.08: за 14 дней ни одного `failed` (7 `admin_preview_sent` + 7 `ready`), недельный план на 31.08–06.09 собран 30.08 в 19:00 за один проход (`all_ready: true`, `problem_count: 0`)
