...
export function JsonLdOrganization({
  ...
  const data = {
    ...
    description:
      'АВАТЕРРА — онлайн-школа мышечного тестирования и кинезиологии Татьяны Стрельцовой. Обучение методу: причина проблемы через обратную связь тела за 30 секунд.',
    areaServed: 'RU',
    inLanguage: 'ru-RU',
