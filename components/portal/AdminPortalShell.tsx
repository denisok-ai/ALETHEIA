...
/**
 * Вся разметка админки с сайдбаром в клиентском модуле — без передачи sections/icons с Server Component в PortalSidebar (избегаем ошибок сериализации RSC).
 */
import {
  LayoutDashboard,
  Users,
...
const adminSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/portal/admin/personal-products', label: 'Персональные товары', icon: icon(Link2) },
      { href: '/portal/admin/installments', label: 'Рассрочки', icon: icon(CalendarClock) },
