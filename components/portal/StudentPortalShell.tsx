...
import { LayoutDashboard, BookOpen, Award, FolderOpen, Bell, User, Headphones, HelpCircle, Video, Zap } from 'lucide-react';
import { PortalSidebar } from '@/components/portal/PortalSidebar';
import { PORTAL_PATH } from '@/lib/portal-paths';

const studentNav = [
  { href: PORTAL_PATH.studentDashboard, label: 'Дашборд', icon: <LayoutDashboard className="h-4 w-4" /> },
  ...
  { href: '/portal/student/gamification', label: 'История заряда', icon: <Zap className="h-4 w-4" /> },
