...
const items = [
  {
    ...
    a: 'Метод обратной связи с телом через проверку реакции мышцы на стимул. Позволяет выявить стресс, дисбаланс и готовность организма к нагрузке без сложной аппаратуры.',
    category: 'Методика',
  },
  {
    q: 'Как проходит консультация?',
    a: 'Специалист задаёт вопросы или воздействует на точки, вы проверяете силу мышцы-индикатора. По реакции тела строится коррекция и рекомендации.',
    category: 'Формат',
  },
  {
    q: 'Можно ли заниматься онлайн?',
    a: 'Да, доступны онлайн-консультации. Формат подбирается индивидуально.',
    category: 'Формат',
  },
  {
    q: 'Сколько длится курс AVATERRA?',
    a: 'Курс включает 10 занятий. Объём программы — 16 модулей, 12+ часов материала.',
    category: 'Курс',
  },
];
    ...
    <section id="faq" ref={ref} className="relative scroll-mt-24 border-t border-[var(--border)] bg-[var(--surface)] py-24 px-5 md:py-28 md:px-6">
      <div className="relative mx-auto max-w-6xl">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <span className="block text-sm font-semibold uppercase tracking-widest text-plum">FAQ</span>
