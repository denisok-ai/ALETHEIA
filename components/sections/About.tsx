      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          ...
          <h2 className="mt-2 font-heading text-3xl font-semibold text-[var(--text)] sm:text-4xl">
            АВАТЕРРА — школа мышечного тестирования
          </h2>
          <p className="mt-5 leading-relaxed text-[var(--text-muted)]">
            АВАТЕРРА (AVATERRA) — онлайн-школа мышечного тестирования и кинезиологии Татьяны Стрельцовой. Мы учим
            находить причину телесного или эмоционального напряжения через обратную связь мышц («тело не врёт») и
            применять метод на себе и с клиентами. Более 15 000 человек прошли программы школы за 20+ лет практики.
          </p>
        </motion.div>
