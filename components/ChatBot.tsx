            ...
            <div className="border-t border-[#E2E8F0] p-4 rounded-b-xl bg-white">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-xl border border-[#E2E8F0] bg-white px-3 py-2.5 text-sm placeholder:text-[var(--portal-text-soft)] focus:outline-none focus:ring-2 focus:ring-[var(--portal-accent)]/50 focus:border-[var(--portal-accent)]"
                  disabled={loading}
                />
                <Button
                  type="button"
