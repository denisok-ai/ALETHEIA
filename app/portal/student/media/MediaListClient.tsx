          ...
          <li key={m.id}>
            <article className="portal-card h-full flex flex-col overflow-hidden
              ...
              >
                ...
                <span
                  className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors motion-reduce:transition-none pointer-events-none"
                  aria-hidden
                />
                <span className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <span
                    className="flex h-11 w-11 items-center justify-center rounded-full bg-white/95 shadow-md
                      text-[var(--portal-primary)] ring-1 ring-black/5
                      motion-reduce:transition-none transition-transform duration-200 group-hover:scale-105"
                  >
              ...
              <div className="flex flex-1 flex-col p-4">
                <div className="flex-1">
                  ...
                  {m.description?.trim() ? (
                    <p
                      className="mt-2 text-xs text-[var(--portal-text-muted)] line-clamp-2 leading-relaxed"
                      title={m.description}
                    >
                      {m.description}
                    </p>
