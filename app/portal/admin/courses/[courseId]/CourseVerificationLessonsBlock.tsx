  ...
  return (
    <div className="portal-card p-4">
      ...
      <p className="mt-1 text-sm text-[var(--portal-text-muted)]">
        Отмеченные уроки — по ним студент должен отправить задание на проверку. Можно задать инструкцию, формат и макс. число файлов. После одобрения менеджером студенту начисляется заряд (геймификация → Настройки → Геймификация).
      </p>
