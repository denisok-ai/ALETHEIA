    ...
    <div className="space-y-6 max-w-7xl">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-5">
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, var(--portal-accent-soft) 0%, var(--portal-accent-muted) 100%)',
            borderColor: 'var(--portal-accent-muted)',
          }}
        >
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[var(--portal-accent)] text-white shadow-sm">
          ...
          <div>
            <p className="text-xs font-semibold text-[var(--portal-accent-dark)] mb-0.5">Выручка (мес.)</p>
