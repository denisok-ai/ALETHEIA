...
const sections = [
  {
    ...
    title: 'Группы курсов',
    description: 'Дерево групп в разделе «Курсы». Фильтрация каталога по группе, вкладка «Группы» в карточке курса, массовое добавление и исключение курсов из групп.',
    icon: BookOpen,
  },
  {
    href: '/portal/admin/media',
    title: 'Группы медиатеки',
    description: 'Дерево групп в разделе «Медиатека». Фильтрация по группе, блок «Группы ресурса» в диалоге редактирования, массовые действия.',
    icon: FolderOpen,
  },
  {
    href: '/portal/admin/users',
    title: 'Группы пользователей',
    description: 'Дерево групп в разделе «Пользователи». Фильтрация по группе, вкладка «Группы» в карточке пользователя (роль участник/модератор), массовые действия.',
    icon: Users,
  },
];
