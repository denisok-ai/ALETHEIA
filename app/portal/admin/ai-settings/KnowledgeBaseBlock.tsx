...
export function KnowledgeBaseBlock() {
  ...
  return (
    <Card
      title="База знаний — чат на лендинге (продукт и продажи)"
      description="Используется только публичным чатом на сайте и в блоке FAQ, не в AI плеера курса. Markdown. Плейсхолдеры: {{COURSE_URL}}, {{PRICING_URL}} (главная #pricing), {{PORTAL_URL}}, {{STUDENT_DASHBOARD_URL}}, {{SUPPORT_EMAIL}}. Цены в текст автоматически не подставляются — формулируйте вручную или ведите на блок цен."
    >
      {loading ? (
