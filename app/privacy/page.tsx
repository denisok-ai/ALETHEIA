  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-24">
      ...
      <div className="mt-10 space-y-8 text-white/85">
        ...
        <section>
          <h2 className="font-heading text-xl font-semibold text-[#f5f0e8]">2. Какие данные мы обрабатываем</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-heading text-xl font-semibold text-[#f5f0e8]">3. Цели обработки</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-heading text-xl font-semibold text-[#f5f0e8]">4. Передача данных третьим лицам</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-heading text-xl font-semibold text-[#f5f0e8]">5. Хранение и защита</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-heading text-xl font-semibold text-[#f5f0e8]">6. Ваши права</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-heading text-xl font-semibold text-[#f5f0e8]">7. Cookies и аналитика</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-heading text-xl font-semibold text-[#f5f0e8]">8. Изменения политики</h2>
          <p className="mt-2">
