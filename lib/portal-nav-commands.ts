...
export const PORTAL_NAV_COMMAND_ITEMS: readonly PortalNavCommandItem[] = [
  ...
  { href: '/portal/admin/mail?tab=inbox', label: 'Почта: Входящие', section: 'Коммуникации', roles: ['admin'] },
  { href: '/portal/admin/mail?tab=mailboxes', label: 'Почта: Почтовые ящики', section: 'Коммуникации', roles: ['admin'] },
  { href: '/portal/admin/mail?tab=mailings', label: 'Почта: Рассылки', section: 'Коммуникации', roles: ['admin'] },
  { href: '/portal/admin/communications', label: 'Письма и сообщения (отдельный экран)', section: 'Коммуникации', roles: ['admin'] },
  { href: '/portal/admin/mailings', label: 'Рассылки (отдельный экран)', section: 'Коммуникации', roles: ['admin'] },
