...
const TRIVIAL_WORDS = new Set([
  ...
  'ок', 'окей', 'спасибо', 'спасибки', 'спс', 'благодарю', 'ага', 'угу', 'да', 'нет',
  'понятно', 'понял', 'поняла', 'ясно', 'хорошо', 'класс', 'супер', 'отлично', 'здорово',
  'thanks', 'thank', 'ok', 'okay',
  // приветствия/прощания
  'привет', 'здравствуйте', 'здравствуй', 'добрый', 'доброе', 'день', 'вечер', 'утро',
  'пока', 'досвидания',
  // усилители, которые сами по себе не несут вопроса
  'большое', 'огромное', 'пожалуйста', 'вам', 'тебе', 'всё', 'все', 'очень',
]);
